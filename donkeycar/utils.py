...
def get_model_by_type(model_type, cfg):
    ...
    from donkeycar.parts.orimodel import OriModel
    ...
    if model_type == "tflite_linear":
    ...
    elif model_type == "behavior" and cfg.TRAIN_BEHAVIORS:
        ...
        kl = FastAiPilot()
    elif model_type == "ori" and cfg.TRAIN_BEHAVIORS:
        kl = OriModel(input_shape=input_shape, num_behavior_inputs=len(cfg.BEHAVIOR_LIST))
        #kl = OriModel(input_shape=input_shape)
