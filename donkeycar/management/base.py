...
class ShowCnnActivations(BaseCommand):
    ...
    def get_activations(self, image_path, model_path, cfg):
        ...
        return activations, conv_layer_names

    def create_figure(self, activations, conv_layer_names):
        import math
        cols = 6
        ...
        for i, layer in enumerate(activations):
            ...
            fig.suptitle(conv_layer_names[i])
    ...
    def run(self, args):
        ...
        activations, names = self.get_activations(args.image, args.model, cfg)
        self.create_figure(activations, names)
