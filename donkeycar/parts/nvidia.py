...
class NvidiaModel(KerasPilot):
    def __init__(self, num_outputs=2, input_shape=(720, 1280, 3), roi_crop=(0, 0), *args, **kwargs):
        ...
        self.model = customModel(num_outputs, input_shape, roi_crop)
        self.compile()
...
def customModel(num_outputs, input_shape, roi_crop):
...
def combineThresholds(img, s_thresh=(170, 255), sx_thresh=(20, 100)):
    img = np.copy(img)
