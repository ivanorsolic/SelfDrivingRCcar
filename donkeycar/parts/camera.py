...
class PiCamera(BaseCamera):
    def __init__(self, image_w=1280, image_h=720, image_d=3, framerate=60):
...
class Webcam(BaseCamera):
    def __init__(self, image_w=1280, image_h=720, image_d=3, framerate = 60, iCam = 0):
        import pygame
...
class CSICamera(BaseCamera):
    ...
    def __init__(self, image_w=1280, image_h=720, image_d=3, capture_width=3280, capture_height=2464, framerate=60, gstreamer_flip=0):
        '''
